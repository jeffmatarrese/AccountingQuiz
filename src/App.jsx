...
const QUESTIONS = [
  ...
  {id:114, section:"Ratios Deep Dive", type:"matching", q:"A company issues $10M in new long-term debt. What happens to each ratio?", pairs:[{label:"Leverage (D/E)",answer:"Increases"},{label:"Current Ratio",answer:"No change"},{label:"Interest Coverage (TIE)",answer:"Decreases"}], options:["Increases","No change","Decreases"], explain:"Leverage (D/E): Increases — liabilities up, equity same. Current Ratio: No change — LT debt isn't current. Interest Coverage (TIE): Decreases over time — more interest expense erodes TIE.", pts:1},
  ...
  {id:132, section:"Ratios Deep Dive", type:"matching", q:"A company issues 1M new shares of common stock at $20/share. What happens to each ratio?", pairs:[{label:"Leverage (D/E)",answer:"Decreases"},{label:"Current Ratio",answer:"Increases"},{label:"ROE",answer:"Decreases"},{label:"EPS",answer:"Decreases"}], options:["Increases","Decreases"], explain:"Leverage (D/E): Decreases — equity up, liabilities same. Current Ratio: Increases — cash up, CL same. ROE: Decreases — equity denominator grows. EPS: Decreases — more shares outstanding, same NI.", pts:1},
  ...
  {id:136, section:"Ratios Deep Dive", type:"matching", q:"A company records $25K of depreciation expense. What happens to each ratio?", pairs:[{label:"ROA",answer:"Decreases"},{label:"Net Profit Margin",answer:"Decreases"},{label:"Asset Turnover",answer:"Increases"},{label:"Current Ratio",answer:"No change"}], options:["Increases","Decreases","No change"], explain:"ROA: Decreases — NI down, assets down. Net Profit Margin: Decreases — NI down, revenue unchanged. Asset Turnover: Increases — total assets decrease, revenue unchanged. Current Ratio: No change — depreciation doesn't affect current assets or CL.", pts:1},
  {id:137, section:"Ratios Deep Dive", type:"matching", q:"A company makes a $10K sale on account (credit sale). COGS is $6K. What happens to each ratio?", pairs:[{label:"Current Ratio",answer:"Increases"},{label:"A/R Turnover",answer:"Depends"},{label:"Net Profit Margin",answer:"Depends"},{label:"Quick Ratio",answer:"Increases"}], options:["Increases","Depends"], explain:"Current Ratio: Increases — A/R up more than inventory down. A/R Turnover: Depends — revenue up, A/R up, net depends on relative size. Net Profit Margin: Depends — depends on overall income mix. Quick Ratio: Increases — A/R is included in quick ratio numerator.", pts:1},

  // RATIOS DEEP DIVE — PART K: INDUSTRY COMPARISON
  {id:138, section:"Ratios Deep Dive", type:"mc", q:"Use the following data:\n\n  Quick Ratio:  ACN 1.2  |  GOOGL 1.9  |  XOM 1.1  |  TGT 0.3\n\nWhich company has the most liquidity risk based on quick ratio?", opts:["ACN","GOOGL","XOM","TGT"], ans:[3], explain:"TGT with 0.3. Its quick ratio is far below 1.0, meaning near-cash assets can't cover current liabilities.", pts:1},
