...
const QUESTIONS = [
  ...
  // SECTION 10: EPS & P/E
  {id:49, section:"EPS & Ratios", type:"mc", q:"Basic EPS is calculated as:", opts:["Net Income / Shares Authorized","(Net Income − Preferred Dividends) / Weighted Average Shares Outstanding","Net Income / Ending Shares Outstanding","EBIT / Total Shares Issued"], ans:[1], pts:1},
  {id:50, section:"EPS & Ratios", type:"mc", q:"The denominator uses weighted average shares outstanding rather than year-end shares because:", opts:["It's required by tax law","The number of shares changes throughout the year, and weighting reflects each period's actual share count","It makes the number larger","Outstanding shares are confidential at year-end"], ans:[1], pts:1},
  {id:51, section:"EPS & Ratios", type:"mc", q:"Diluted EPS is always ______ basic EPS.", opts:["Greater than","Less than or equal to","Equal to","Unrelated to"], ans:[1], explain:"Diluted assumes all potentially dilutive securities convert to common, increasing the denominator.", pts:1},
  {id:52, section:"EPS & Ratios", type:"mc", q:"A stock trades at $60/share with EPS of $4. The P/E ratio is:", opts:["4","15","240","0.067"], ans:[1], explain:"$60 / $4 = 15. Investors pay $15 for every $1 of current earnings.", pts:1},

  // SECTION 11: DUPONT & QUALITY
  {id:53, section:"EPS & Ratios", type:"mc", q:"The DuPont decomposition of ROE is:", opts:["Net Income / Revenue × Revenue / Equity","(Net Income / Sales) × (Sales / Assets) × (Assets / Equity)","EBIT / Total Assets × Total Assets / Revenue","Gross Profit / Sales × Sales / Equity"], ans:[1], explain:"= Profit Margin × Asset Turnover × Financial Leverage", pts:1},
